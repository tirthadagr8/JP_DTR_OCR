...
class DTrOCRConfig:
    def __init__(
        self,
        mbart_hf_model: str = 'tirthadagr8/custom-mbart-large-50',
        gpt2_hf_model: str = 'openai-community/gpt2',
        vit_hf_model: str = 'google/vit-base-patch16-224-in21k',
        vocab_size: Optional[int] = 253944,
        max_position_embeddings: Optional[int] = 256,
        hidden_size: Optional[int] = 768,
        num_hidden_layers: Optional[int] = 12,
        num_attention_heads: Optional[int] = 12,
        patch_size: Optional[Union[Tuple[int], List[int]]] = (8, 8),      # (height, width)
        image_size: Optional[Union[Tuple[int], List[int]]] = (128, 96),   # (height, width)
        ...
        self.mbart_hf_model = mbart_hf_model
